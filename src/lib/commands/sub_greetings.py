...
RENAME = (('msg_param_cumulative_months', 'm'),
...
def sub_greetings(self, args, msg):
    ...
    if 'msg_param_cumulative_months' not in resp_kwargs:
        resp_kwargs['msg_param_cumulative_months'] = 0
...
if __name__ == '__main__':
    ...
    {'badges': 'subscriber/3', 'color': '#1E90FF', 'display_name': 'alanmerf', 'emotes': '', 'flags': '', 'id': '574677eb-081b-482d-bef5-69a1aa4cea36',
     'login': 'alanmerf', 'mod': '0', 'msg_id': 'submysterygift', 'msg_param_mass_gift_count': '2', 'msg_param_sender_count': '12',
    ...
    {'badges': 'subscriber/3', 'color': '#1E90FF', 'display_name': 'alanmerf', 'emotes': '', 'flags': '', 'id': '6633025d-d7e7-44d5-b317-70e6a86fe90d',
     'login': 'alanmerf', 'mod': '0', 'msg_id': 'subgift', 'msg_param_cumulative_months': '1', 'msg_param_recipient_display_name': '0qq_',
    ...
    {'badges': 'subscriber/3', 'color': '#1E90FF', 'display_name': 'alanmerf', 'emotes': '', 'flags': '',
     'id': '6633025d-d7e7-44d5-b317-70e6a86fe90d',
     'login': 'alanmerf', 'mod': '0', 'msg_id': 'subgift', 'msg_param_cumulative_months': '1',
     'msg_param_recipient_display_name': '0qq_',
     'msg_param_recipient_id': '47010203', 'msg_param_recipient_user_name': 'pexovan', 'msg_param_sender_count': '0',
     'msg_param_sub_plan_name': 'Nastjadd\\s<3', 'msg_param_sub_plan': '1000', 'room_id': '55935171',
     'subscriber': '1',
     'system_msg': 'alanmerf\\sgifted\\sa\\sTier\\s1\\ssub\\sto\\s0qq_!', 'tmi_sent_ts': '1538742841592',
     'turbo': '0',
     'user_id': '103295621', 'user_type': '', 'chan': '#c_a_k_e', 'msg': ''},
    ...
    {'badges': 'subscriber/12,sub-gifter/1', 'color': '#FA983A', 'display_name': 'Lanvilla', 'emotes': '', 'flags': '',
     ...
     'msg_param_cumulative_months': '1', 'msg_param_recipient_display_name': 'ppsrob', 'msg_param_recipient_id': '116879356',
    ...
    {'badges': 'subscriber/12,sub-gifter/1', 'color': '#FA983A', 'display_name': 'Lanvilla', 'emotes': '', 'flags': '',
     ...
     'msg_param_cumulative_months': '1', 'msg_param_recipient_display_name': 'dmitriymalikob',
    ...
    {'badges': 'subscriber/12,sub-gifter/1', 'color': '#FA983A', 'display_name': 'Lanvilla', 'emotes': '', 'flags': '',
     ...
     'msg_param_cumulative_months': '1', 'msg_param_recipient_display_name': 'BavARetS', 'msg_param_recipient_id': '40646604',
    ...
    {'badges': 'subscriber/12,sub-gifter/1', 'color': '#FA983A', 'display_name': 'Lanvilla', 'emotes': '', 'flags': '',
     ...
     'msg_param_cumulative_months': '1', 'msg_param_recipient_display_name': 'marks_ds', 'msg_param_recipient_id': '239827875',
     ...
     'msg': ''}]
    import json
    for x in json.load(open('subs.txt', 'rt', encoding='utf-8-sig')):
        if 'msg_param_sub_plan' in x:
